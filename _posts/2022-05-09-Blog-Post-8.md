...
Now that the very basics, we can move on to some basic image processing.
...
Nice, we've definitely made. We'll get into more interesting concepts in the next post! See you there.
