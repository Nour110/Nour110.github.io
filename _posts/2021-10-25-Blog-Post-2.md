...
\
Note: you type `response.css("[href^='fullcredits']").attrib` in the scrapy shell and it'll output a dictionary that'll give you all the atrribute names as keys and the info they hold as values.\
